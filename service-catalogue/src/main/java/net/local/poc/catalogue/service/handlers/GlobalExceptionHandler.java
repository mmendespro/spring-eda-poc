package net.local.poc.catalogue.service.handlers;
...
import net.local.poc.catalogue.service.handlers.exceptions.ServiceApiException;
import net.local.poc.catalogue.service.handlers.model.ApiErrorResponse;
...
public class GlobalExceptionHandler {
	...
	public Mono<ResponseEntity<ApiErrorResponse>> handleServiceApiException(ServiceApiException exception) {
		...
		var responseEntity = ResponseEntity.status(exception.getHttpStatus()).body(new ApiErrorResponse(exception.getMessage()));
